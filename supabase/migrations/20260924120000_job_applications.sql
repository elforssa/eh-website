...
revoke all on function public.check_job_application_rate_limit(text, text, integer, integer) from public;
...
revoke all on function public.create_job_application(jsonb) from public;
...
revoke all on function public.consume_job_application_thank_you(uuid, uuid) from public;
...
revoke all on function public.claim_unreferenced_job_application_upload(text) from public;
...
revoke all on function public.claim_abandoned_job_application_uploads(integer) from public;
...
revoke all on function public.claim_job_application_meta_deliveries(integer, uuid, uuid) from public;
...
revoke all on function public.claim_job_application_sheet_deliveries(integer, uuid, uuid) from public;
